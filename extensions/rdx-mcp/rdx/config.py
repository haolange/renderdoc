...
class ArtifactConfig:
    store_path: Path = field(default_factory=lambda: Path("./rdx_artifacts"))
...
class DatabaseConfig:
    path: Path = field(default_factory=lambda: Path("./rdx_data/metadata.db"))
    fingerprint_path: Path = field(default_factory=lambda: Path("./rdx_data/fingerprints.db"))
...
@dataclass
class ReportConfig:
    output_path: Path = field(default_factory=lambda: Path("./rdx_reports"))
