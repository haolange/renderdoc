...
from .aird_bridge import record_aird_evidence
    ...
    async def execute(
        ...
        *,
        ...
        try:
            ...
            try:
                aird_meta = record_aird_evidence(
                    operation=operation,
                    args=payload_args,
                    payload=normalized,
                ...
                if aird_meta:
                    normalized["meta"].update(aird_meta)
            except Exception:
                # Evidence publishing is best-effort and must not break tool execution.
                pass
            return normalized
